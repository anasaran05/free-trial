...
interface CircularTextProps {
  ...
  className?: string;
 centerContent?: React.ReactNode; // ✅ Add this
...
>
  ...
  {/* Center content */}
{centerContent && (
  <div className="absolute inset-0 flex items-center justify-center pointer-events-none text-white text-xl">
    {centerContent}
  </div>
)}
</motion.div>
  ...
  <motion.div
  className={`m-0 mx-auto rounded-full relative font-black text-white text-center cursor-pointer origin-center ${backgroundClass || ""} ${className || ""}`}
></motion.div>
};
